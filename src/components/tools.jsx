  ...
  return (
    <div className="tools-container">
      ...
      <div className="flex-container">
        ...
        <div className="grid-item" data-aos="fade-right" data-aos-delay="100">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 128 128">
            <path
              fill="#0074BD"
        ...
        <div className="grid-item" data-aos="fade-right" data-aos-delay="200">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 128 128">
        ...
        <div className="grid-item" data-aos="fade-right" data-aos-delay="300">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 128 128">
            <linearGradient
        ...
        <div className="grid-item" data-aos="fade-right" data-aos-delay="400">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 128 128">
            <linearGradient
              id="ruby-original-a"
              gradientUnits="userSpaceOnUse"
